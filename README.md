...
- **Assets screener** — Search and filter stocks (or other assets) by criteria (e.g. valuation, growth, dividends, sector). References: [TradingView Stock Screener](https://www.tradingview.com/screener/), [Seeking Alpha Screeners](https://seekingalpha.com/screeners), [AInvest Aime Screener](https://www.ainvest.com/aime/screener/) (good screener; missing visualizations — we’d add charts/heatmaps). Good possible feature for discovering ideas that match our metrics and valuation context.
